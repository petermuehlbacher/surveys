...
\begin{proof}
	...
	Betrachte daf\"ur $F(x+he_i)-F(x)$ im Grenzwert $h\rightarrow 0$.\todo{evt. Rest des Beweises nachbringen, ist aber auch nur noch recht technisch.}
\end{proof}
...
\begin{proof}
	...
	Es bleibt zu zeigen, dass $D_i F = f_i$. \todo{technischer Beweis, evt. nachbringen}
